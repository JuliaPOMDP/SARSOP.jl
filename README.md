...
This Julia package wraps the [SARSOP](http://bigbird.comp.nus.edu.sg/pmwiki/farm/appl/) software for offline POMDP planning. An interface for writing POMDPX files is provided through the [POMDPXFile.jl](https://github.com/sisl/POMDPXFile.jl) package. 
...
```julia
Pkg.clone("https://github.com/sisl/POMDXFile.jl")
```
